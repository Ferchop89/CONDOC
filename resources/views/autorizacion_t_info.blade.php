...
@section('content')
<div class="container" class="cont_aut">
	<h1 align="center">AUTORIZACIÓN DE TRANSFERENCIA DE INFORMACIÓN</h1>
	<div class="d_m">
		<p><i>Por favor, completa los campos con la información correcta.</i></p>
	</div>
	<form method="POST" action="{{ url('/ati') }}">
		{!! csrf_field() !!}
		@if ($errors->any())
  ...
  <div class="div_cont">
		...
		<br>
		<p align="justify">
			<div><b>C.P. Agustín Mercado</b></div>
		...
		<p align="justify">CURP: <input type="text" class="width_c" name="curp"></p>
